...
class ViewSalle(ctk.CTk):
    ...
    def __init__(self):
        ...
        self.btn_add = ctk.CTkButton(self.frame_btn, text="Ajouter", command=self.ajouter_salle)
        self.btn_add.pack(side="left", padx=5)

        self.btn_mod = ctk.CTkButton(self.frame_btn, text="Modifier", command=self.modifier_salle)
        self.btn_mod.pack(side="left", padx=5)

        self.btn_del = ctk.CTkButton(self.frame_btn, text="Supprimer", command=self.supprimer_salle)
        self.btn_del.pack(side="left", padx=5)

        self.btn_search = ctk.CTkButton(self.frame_btn, text="Rechercher", command=self.rechercher_salle)
